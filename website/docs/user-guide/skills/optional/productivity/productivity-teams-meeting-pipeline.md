...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/productivity/teams-meeting-pipeline` |
| Path | `optional-skills/productivity/teams-meeting-pipeline` |
| Version | `1.1.0` |
