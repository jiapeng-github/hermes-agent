...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/productivity/google-workspace` |
...
| Related skills | [`himalaya`](/docs/user-guide/skills/optional/email/email-himalaya) |
