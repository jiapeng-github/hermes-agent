...
| Related skills | [`maps`](/docs/user-guide/skills/optional/productivity/productivity-maps), [`google-workspace`](/docs/user-guide/skills/optional/productivity/productivity-google-workspace), [`agentmail`](/docs/user-guide/skills/optional/email/email-agentmail) |
