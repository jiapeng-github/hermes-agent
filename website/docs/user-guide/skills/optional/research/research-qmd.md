...
| Related skills | [`obsidian`](/docs/user-guide/skills/optional/note-taking/note-taking-obsidian), [`hermes-agent`](/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-hermes-agent), [`arxiv`](/docs/user-guide/skills/optional/research/research-arxiv) |
