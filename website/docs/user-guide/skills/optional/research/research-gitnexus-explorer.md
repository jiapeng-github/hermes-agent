...
| Related skills | [`hermes-agent`](/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-hermes-agent), [`codebase-inspection`](/docs/user-guide/skills/optional/github/github-codebase-inspection) |
