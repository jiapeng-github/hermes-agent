...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/software-development/hermes-agent-skill-authoring` |
| Path | `optional-skills/software-development/hermes-agent-skill-authoring` |
| Version | `2.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `skills`, `authoring`, `hermes-agent`, `conventions`, `skill-md` |
| Related skills | [`plan`](/docs/user-guide/skills/optional/software-development/software-development-plan), [`requesting-code-review`](/docs/user-guide/skills/optional/software-development/software-development-requesting-code-review) |
