...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/github/github-code-review` |
| Path | `optional-skills/github/github-code-review` |
| Version | `1.1.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `GitHub`, `Code-Review`, `Pull-Requests`, `Git`, `Quality` |
| Related skills | [`github-auth`](/docs/user-guide/skills/optional/github/github-github-auth), [`github-pr-workflow`](/docs/user-guide/skills/optional/github/github-github-pr-workflow) |
