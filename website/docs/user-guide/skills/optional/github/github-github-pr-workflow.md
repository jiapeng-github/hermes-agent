...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/github/github-pr-workflow` |
| Path | `optional-skills/github/github-pr-workflow` |
| Version | `1.1.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `GitHub`, `Pull-Requests`, `CI/CD`, `Git`, `Automation`, `Merge` |
| Related skills | [`github-auth`](/docs/user-guide/skills/optional/github/github-github-auth), [`github-code-review`](/docs/user-guide/skills/optional/github/github-github-code-review) |
