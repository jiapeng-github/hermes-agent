...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/autonomous-ai-agents/hermes-agent` |
| Path | `optional-skills/autonomous-ai-agents/hermes-agent` |
| Version | `3.1.0` |
...
| Related skills | [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`codex`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`opencode`](/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-opencode) |
