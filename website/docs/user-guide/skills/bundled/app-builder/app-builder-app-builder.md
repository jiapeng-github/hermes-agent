...
description: "Create, modify, repair, validate, publish, roll back, export, or import profile-scoped Hermes Web applications for the App Market"
---
...
Create, modify, repair, validate, publish, roll back, export, or import profile-scoped Hermes Web applications for the App Market. Use when the user invokes /app-builder, asks for a reusable browser application backed by Hermes Runtime actions, asks to change an existing App Market application, or needs a .happ package lifecycle operation.
...
Before invoking the CLI, read [references/cli.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/app-builder/references/cli.md). Before creating or changing `app.yaml`, actions, schemas, or permissions, read [references/runtime-contract.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/app-builder/references/runtime-contract.md).
