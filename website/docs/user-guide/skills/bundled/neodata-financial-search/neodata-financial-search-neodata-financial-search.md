---
title: "Neodata Financial Search — NeoData Financial Search — natural language financial data search"
sidebar_label: "Neodata Financial Search"
...
| Path | `skills/neodata-financial-search` |
| Version | `1.0.1` |
...
详细的数据服务目录和完整的出入参字段说明见 [reference.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/neodata-financial-search/reference.md)。
