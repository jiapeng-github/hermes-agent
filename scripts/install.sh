...
# Configuration
REPO_URL_SSH="git@github.com:jiapeng-github/hermes-agent.git"
REPO_URL_HTTPS="https://github.com/jiapeng-github/hermes-agent.git"
...
emit_manifest() {
    ...
    # install.ps1: the signed bootstrap installer (StockSense-Setup) passes it so
