//! StockSense Setup — Tauri entrypoint.
//!
...
/// desktop app handing off via `StockSense-Setup.exe --update`).
///
...
pub fn run() {
    ...
    tracing::info!(?mode, force_setup, "StockSense installer starting");
    ...
    tauri::Builder::default()
        ...
        .expect("error while running StockSense Setup");
}
