...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteDesc:
        'Connect this desktop shell to a remote StockSense backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'StockSense Desktop will reconnect using the saved settings.',
    ...
    toolsets: {
      ...
      ready: 'Ready',
      nousIncluded: 'Included with a StockSense subscription — sign in to Nous Portal to activate.',
  ...
  install: {
    ...
    settingUpTitle: 'Setting up StockSense',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with StockSense",
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid StockSense subscription.',
    free: 'Free',
    freeTier: 'Free tier',
