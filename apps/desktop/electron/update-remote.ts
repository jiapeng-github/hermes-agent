 ...
 *
 * A public install can end up with `origin=git@github.com:jiapeng-github/hermes-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/jiapeng-github/hermes-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/jiapeng-github/hermes-agent'
