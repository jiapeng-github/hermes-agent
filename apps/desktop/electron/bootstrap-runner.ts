...
function downloadInstallScript(ref, destPath) {
  ...
  const url = `https://raw.githubusercontent.com/jiapeng-github/hermes-agent/${ref}/scripts/${scriptName}`
...
function spawnPowerShell(
  scriptPath,
  args,
  { emit, stageName, abortSignal, hermesHome, stockMcpDefaultsPath, offlineRuntimePath }: any = {}
) {
